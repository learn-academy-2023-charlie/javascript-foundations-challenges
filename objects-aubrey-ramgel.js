...
//output is "Arthur Dent is from planet Earth"
//process: take the objects 'arthur' and 'dent' & add statement 'is from planet' added to the object 'earth'
// const person = {
//     firstName: "Arthur",
//     lastName: "Dent",
//     homePlanet: "Earth",
...
const person = {
    firstName: "Arthur",
    lastName: "Dent",
    newString: "is from planet",
    homePlanet: "Earth",
    getFunction: function () {
        return `${this.firstName} ${this.lastName} ${this.newString} ${this.homePlanet}`
    }
}
